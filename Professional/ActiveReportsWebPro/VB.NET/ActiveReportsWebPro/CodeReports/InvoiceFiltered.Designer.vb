Namespace CodeReports
	...
	Partial Public Class InvoiceFiltered
		...
		Private Sub InitializeComponent()
			...
			OleDBDataSource1.SQL = "SELECT * FROM Invoices " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE ((OrderDate >= #<%StartingDate|Starting Date:|1994-" & _
				"8-1|D%>#) AND (OrderDate <= #<%EndingDate|Ending Date:|1994-9-1|D%>#))" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ORDER B" & _
				"Y OrderID"
